...
export type StorageHash =
  StorageHashBase<'ff3a1e75b01d38acf7c4c490b9a65d9168724b0483e2a3b74cdfc6ef4f03265d'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly SystemRouter: {
      ...
      readonly routeType: 'set' | 'group' | 'directory' | 'page' | 'button';
...
export type StorageColumnTypes = {
  readonly public: {
    readonly system_routers: {
      ...
      readonly route_type: 'set' | 'group' | 'directory' | 'page' | 'button';
...
export namespace Models {
  export type public_SystemRouter = {
    ...
    routeType: 'set' | 'group' | 'directory' | 'page' | 'button';
        ...
        readonly entries: {
          ...
          readonly valueSet: {
            readonly RouteType: {
              ...
              readonly values: readonly ['set', 'group', 'directory', 'page', 'button'];
            };
          };
        };
      };
