...
export type StorageHash =
  StorageHashBase<'f325de6b30d74d373a749834c2593375912d04542cbf978a218bf53247ba90a0'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly SystemRouter: {
      ...
      readonly parentId: CodecTypes['pg/text@1']['output'] | null;
      readonly routeType: 'set' | 'group' | 'page' | 'directory' | 'link' | 'button';
      readonly sortOrder: CodecTypes['pg/int4@1']['output'];
...
export type StorageColumnTypes = {
  readonly public: {
    ...
    readonly system_routers: {
      ...
      readonly parent_id: CodecTypes['pg/text@1']['output'] | null;
      readonly path: CodecTypes['pg/text@1']['output'] | null;
      readonly route_type: 'set' | 'group' | 'page' | 'directory' | 'link' | 'button';
      readonly scope: 'public' | 'admin';
      readonly sort_order: CodecTypes['pg/int4@1']['output'];
      readonly updated_at: CodecTypes['pg/timestamptz-string@1']['output'];
    };
      ...
      readonly public: {
        ...
        readonly entries: {
          ...
          readonly valueSet: {
            ...
            readonly RouteType: {
              readonly kind: 'valueSet';
              readonly values: readonly ['set', 'group', 'page', 'directory', 'link', 'button'];
            };
          };
        };
      };
