...
import {
    Column,
    features,
} from "@/components/client/content-category/content-category-table-column";
import { FolderTree } from "lucide-react";
import { cn } from "cn";

interface Props {
    data: ContentCategoryTreeNode[];
    columns: Column;
}
