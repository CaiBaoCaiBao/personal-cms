...
export type StorageHash =
  StorageHashBase<'87fe52a34f64e5e88b403ab506f1a0c5996f561436f102b2dc94fde1b6b43a6f'>;
        ...
        readonly entries: {
          readonly table: {
            readonly categories: {
              ...
              uniques: readonly [{ readonly columns: readonly ['name', 'parent_id'] }];
              indexes: readonly [
                {
            ...
            readonly tag_aliases: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['alias_name'] }];
              indexes: readonly [
                {
